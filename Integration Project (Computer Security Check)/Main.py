            ...
            if appet_qt < 0:
                ...
                while True:
                    try:
                        ...
                        print("Improper Input. Please provide an integer"
                              ".")
                        raise(notAnumber)
        else:
...
def main():
    ...
    if main_dish_choice == "1" or main_dish_choice == "2" \
        ...
        print("Invalid input please enter the corresponding ")
    ...
    if bev_choice == "1" or bev_choice == "2" or bev_choice == "3":
        while True:
            try:
                ...
                print("Improper Input. Please provide an integer that is greater than 0.")
    if bev_qt < 0:
        print("Improper Input please provide a Positive whole number.")
        while True:
            try:
                ...
                print("Improper Input. Please provide a Positive number.")
        while True:
                try:
                    bev_qt = int(input("How many servings "
                                                "would you like?: "))
                    break
                except ValueError:
                    print("It must be an integer that is greater than 1.")
